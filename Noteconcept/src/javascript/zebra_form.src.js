                                        ...
                                        $proxy.each(function() {
                                            ...
                                            switch (type) {
                                                ...
                                                case 'checkbox':
                                                    ...
                                                    if (undefined != $(this).attr('checked')) value.push($(this).val());
            ...
            if (
                ...
                for (var rule in control_validation_rules['rules']) {
                    ...
                    if (!control_is_valid) {
                        ...
                        else control_validation_rules.message = plugin.settings.validation_rules[id][rule_not_passed][plugin.settings.validation_rules[id][rule_not_passed].length - 1];
            ...
            for (var proxy in conditions) {
                ...
                // if we don't have a cached result of the result
                    ...
                    if (result) {
                        ...
                        // if any of the condition is not met, flag that
                        if (!proxies[proxy]['conditions'][function_name]()) result = false;
